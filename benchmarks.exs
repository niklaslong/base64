...
Benchee.run(
  %{
    "Rust Nif encode" => fn input -> Base64.encode(input) end,
    "Elixir/Erlang encode" => fn input -> Base.encode64(input) end,
  },
  inputs: %{
    "Small" => short_string,
    "Bigger" => long_string
